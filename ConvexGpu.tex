...
heuristic works with actual times when the offline one uses predicted times thus
...
original heuristic select two independent random nodes and uses
...
\mytodo{Relire jusqu'au IV-A (inclus)}
...
As offline heft, the convex clusters algorithm provide better results for small
